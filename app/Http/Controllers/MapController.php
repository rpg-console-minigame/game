...
class MapController extends Controller
{
   ...
   public function index(Request $request) {
    ...
    if ($user && Hash::check($password, $user->password)) {
        ...
        return view("mapEditor", ["map" => $map, "items" => $items, "success" => true]);  // Incluye el mensaje de éxito
    } else {
        return view('mapEditor', ["error" => "Usuario o contraseña incorrectos"]);
    }
}
...
function create(Request $request) {
    ...
    if ($validator->passes()) {
        ...
        // Actualizar vista con mensaje de éxito
        $map = \App\Models\Zona::all();
        $items = \App\Models\Objeto::all();
        return view("mapEditor", ["map" => $map, "items" => $items, "success" => "Zona creada exitosamente"]);
    } else {
        $map = \App\Models\Zona::all();
        $items = \App\Models\Objeto::all();
        return view("mapEditor", ["map" => $map, "items" => $items, "error" => "Es necesario nombre o descripcion"]);
    }
}
...
function delete(Request $request) {
    ...
    $map = \App\Models\Zona::all();
    $items = \App\Models\Objeto::all();
    return view("mapEditor", ["map" => $map, "items" => $items, "success" => "Zona eliminada exitosamente"]);
}
...
function update(Request $request) {
    ...
    if ($validator->passes()) {
        ...
        $map = \App\Models\Zona::all();
        $items = \App\Models\Objeto::all();
        return view("mapEditor", ["map" => $map, "items" => $items, "success" => "Zona actualizada exitosamente"]);
    } else {
        $map = \App\Models\Zona::all();
        $items = \App\Models\Objeto::all();
        return view("mapEditor", ["map" => $map, "items" => $items, "error" => "Es necesario nombre o descripcion"]);
