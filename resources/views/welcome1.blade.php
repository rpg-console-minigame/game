...
<head>
    ...
    <style>
        ...
        .fixed-button.jugar {
            position: fixed;
            bottom: 80px;
            /* Subido para hacerlo más visible */
            right: 20px;
            z-index: 10000;
        }
        ...
        .fixed-button.borrar {
            position: fixed;
            bottom: 80px;
            /* Igual que el botón jugar */
            right: 140px;
            /* Separado para que estén paralelos */
            z-index: 10000;
        }
        ...
        .d-flex.justify-content-center.gap-4.mt-4 {
            flex-wrap: wrap;
            /* Permite que los botones bajen a la siguiente fila si no caben */
            gap: 1rem;
            /* Separación consistente entre botones */
            justify-content: center;
            /* Centra los botones en todas las pantallas */
        ...
        .btn-borrar {
            flex: 1 1 150px;
            /* Crecen y encogen, con mínimo 150px */
            max-width: 300px;
            /* Opcional, para que no crezcan demasiado */
            margin: 0;
            /* Sin margen para evitar espacios extra */
            padding: 12px 20px;
            /* Ajusta el padding para que sean cómodos en móvil */
            box-sizing: border-box;
            white-space: nowrap;
            /* Para evitar que el texto se rompa en dos líneas */
        }
        ...
        @media (max-width: 480px) {
            ...
            .btn-borrar {
                flex: 1 1 100%;
                /* Botones en columna a 100% ancho */
                max-width: 100%;
            }
        }
    </style>
